...
# - **Teaching Assistants**: [Karolina Stanczak](https://kstanczak.github.io/), [Erik Arakelyan](https://scholar.google.co.uk/citations?user=63BfrxMAAAAJ), [Nadav Borenstein](https://scholar.google.com/citations?user=uDM-PC0AAAAJ), [Ruixiang Cui](https://ruixiangcui.github.io/)
...
#       * Lab (09.09 & 12.09): Jupyter notebook setup, introduction to [Colab](https://colab.research.google.com/). Introduction to [PyTorch](https://pytorch.org/tutorials/). Project group arrangements. Questions about the course project. ([lab](labs/notebooks_2020_2021/lab_1.ipynb))
#   * Week 37 (12-16 Sept)
...
#       * Lab (16.09 & 19.09): Recurrent Neural Networks and word representations. Project help. ([lab](labs/notebooks_2020_2021/lab_2.ipynb))
...
#       * Lab (23.09 & 28.09): Language Models with [Transformers](https://huggingface.co/course/chapter1) and RNNs. Project help. ([lab](labs/notebooks_2020_2021/lab_3.ipynb))
#   * Week 39 (26-30 Sept)
...
#       * Lab (30.09 & 03.10): Error analysis and explainability. Project help. ([lab](labs/notebooks_2020_2021/lab_4.ipynb))
#   * Week 40 (3-7 Oct)
#       * Lecture (Tuesday): Sequence Labelling ([slides](chapters/sequence_labeling_slides.ipynb), [notes](chapters/sequence_labeling.ipynb))
#       * Lab (07.10 & 10.10): Sequence labelling. Beam search. Project help. ([lab](labs/notebooks_2020_2021/lab_5.ipynb))
...
#       * Lab (14.10 & 24.10): In-depth look at Transformers and Multilingual QA. Project help. ([lab](labs/notebooks_2020_2021/lab_6.ipynb))
#   * Week 43 (24-28 Oct)
